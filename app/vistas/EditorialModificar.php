...
<body>
      ...
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Modificación de Editorial</span>
    ...
    <!-- Formulario -->
    <form id="formulario" action='<?php print RUTA_APP."editorial/modificar/"; ?>' method="POST">
    <div class="form-group">
      <label for="nombre">Nombre Editorial</label>
        <input type="text" class="form-control margin-bottom" name="nombre" value="<?php print $data["nombre"];?>">
    </div>
    <div class="form-group">
