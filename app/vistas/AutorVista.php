...
<body>
    ...
    <div id="barraCrear" class="row justify-content-center">
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Listado de Autores</span>
          <form class="form-inline">
            <a class="btn btn-primary" role="button" href="<?php print RUTA_APP."autor/crea";?>"><i class='fas fa-edit'></i> Crear nuevo autor</a>
          </form>
      </nav>
    </div>
    <!-- Tabla -->
        ...
        <tbody>
          <?php
            for ($i=0; $i < count($data); $i++) { 
              ...
              print "<td>".$data[$i]["apellidopat"]."</td>";
              print "<td>".$data[$i]["apellidomat"]."</td>";
              print "<td><a class='btn btn-success' role='button' href='".RUTA_APP."autor/modificar/".$data[$i]["id"]."'><i class='fas fa-edit'></i></a></td>";
              print "<td><a class='btn btn-danger' role='button' href='".RUTA_APP."autor/borrar/".$data[$i]["id"]."'><i class='fas fa-trash-alt'></i></a></td>";
              print "</tr>";
            }
          ?>
        </tbody>
