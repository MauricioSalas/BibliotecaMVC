...
<body>
    ...
    <div id="barraCrear" class="row justify-content-center">
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Creación de Nuevo Autor</span>
    ...
    <!-- Formulario -->
  <form id="formulario" action='<?php print RUTA_APP."autor/crea/";?>' method="POST">
    <div class="form-group">
      <label for="nombres">Nombres</label>
        <input type="text" class="form-control margin-bottom" name="nombres" placeholder="Inserte nombres del Autor">
    </div>
    <div class="form-group">
      <label for="apellidopat">Apellido Paterno</label>
        <input type="text" class="form-control margin-bottom" name="apellidopat" placeholder="Inserte Apellido Paterno del Autor">
    </div>
    <div class="form-group">
      <label for="apellidomat">Apellido Materno</label>
        <input type="text" class="form-control margin-bottom" name="apellidomat" placeholder="Inserte Apellido Materno del Autor">
    </div>
