...
<body>
      ...
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Modificación de Autor</span>
    ...
    <!-- Formulario -->
    <form id="formulario" action='<?php print RUTA_APP."autor/modificar/"; ?>' method="POST">
    <div class="form-group">
      <label for="nombres">Nombres</label>
        <input type="text" class="form-control margin-bottom" name="nombres" value="<?php print $data["nombres"];?>">
    </div>
    <div class="form-group">
      <label for="apellidopat">Apellido Paterno</label>
        <input type="text" class="form-control margin-bottom" name="apellidopat" value="<?php print $data["apellidopat"];?>">
    </div>
    <div class="form-group">
      <label for="apellidomat">Apellido Materno</label>
      <input type="text" class="form-control margin-bottom" name="apellidomat" value="<?php print $data["apellidomat"];?>">
    </div>
    <div class="form-group">
