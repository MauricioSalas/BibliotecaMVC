...
<body>
    ...
    <div id="barraCrear" class="row justify-content-center">
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Creación de Nuevo Libro</span>
          <form class="form-inline">
            <a class="btn btn-warning" role="button" href="<?php print RUTA_APP."libros"; ?>"><i class='fas fa-undo-alt'></i> Regresar</a>
          </form>
      </nav>
    </div>
    <!-- Formulario -->
  <form id="formulario" action='<?php print RUTA_APP."libros/crea/";?>' method="POST">
    <div class="form-group">
      <label for="titulo">Título</label>
        <input type="text" class="form-control margin-bottom" name="titulo" placeholder="Inserte título">
    </div>
    <div class="form-group">
      <label for="autor">Autor</label>
        <input type="number" class="form-control margin-bottom" name="autor" placeholder="Seleccione autor">
    </div>
    <div class="form-group">
      <label for="editorial">Editorial</label>
      <input type="number" class="form-control margin-bottom" name="editorial" placeholder="Seleccione editorial">
    </div>
    <div class="form-group">
      <label for="isbn">ISBN (International Standard Book Number)</label>
        <input type="text" class="form-control margin-bottom" name="isdn" placeholder="Inserte ISBN">
    </div>
