...
<body>
      ...
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Eliminar Libro</span>
    ...
    <!-- Formulario -->
    <form id="formulario" action='<?php print RUTA_APP."libros/borrar/"; ?>' method="POST">
    <div class="form-group">
      <label for="titulo">Título</label>
        <input type="text" class="form-control margin-bottom" name="titulo" value="<?php print $data["titulo"];?>" disabled>
    </div>
    <div class="form-group">
      <label for="autor">Autor</label>
        <input type="number" class="form-control margin-bottom" name="autor" value="<?php print $data["autor"];?>"disabled>
    </div>
    <div class="form-group">
      <label for="editorial">Editorial</label>
      <input type="number" class="form-control margin-bottom" name="editorial" value="<?php print $data["editorial"];?>"disabled>
    </div>
    <div class="form-group">
