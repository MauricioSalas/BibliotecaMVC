...
<body>
    ...
    <div id="barraCrear" class="row justify-content-center">
      <nav class="navbar navbar-light bg-light rounded border border-dark">
        <span class="navbar-brand">Creación de Nueva Editorial</span>
    ...
    <!-- Formulario -->
  <form id="formulario" action='<?php print RUTA_APP."editorial/crea/";?>' method="POST">
    <div class="form-group">
      <label for="nombre">Nombre</label>
        <input type="text" class="form-control margin-bottom" name="nombre" placeholder="Inserte nombre de la editorial">
    </div>
